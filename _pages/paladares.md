...
<div style="margin-bottom: 40px;">
  ...
  <div class="row row-cols-3 g-2">
    <div class="col">
      <a href="{{ '/assets/img/ham.jpg' | relative_url }}" data-lightbox="ham">
        <img src="{{ '/assets/img/ham.jpg' | relative_url }}" class="img-fluid rounded" style="aspect-ratio: 1; object-fit: cover;">
      </a>
    </div>
    <div class="col">
    ...
    <div class="col">
      <a href="{{ '/assets/img/cafec.jpg' | relative_url }}" data-lightbox="cafec">
        <img src="{{ '/assets/img/cafec.jpg' | relative_url }}" class="img-fluid rounded" style="aspect-ratio: 1; object-fit: cover;">
      </a>
    </div>
  </div>
...
<div style="margin-bottom: 40px;">
  ...
  <div class="row row-cols-3 g-2">
    <div class="col">
      <a href="{{ '/assets/img/resto1a.jpg' | relative_url }}" data-lightbox="resto1">
        <img src="{{ '/assets/img/resto1a.jpg' | relative_url }}" class="img-fluid rounded" style="aspect-ratio: 1; object-fit: cover;">
      </a>
    </div>
    <div class="col">
      <a href="{{ '/assets/img/resto1b.jpg' | relative_url }}" data-lightbox="resto1">
        <img src="{{ '/assets/img/resto1b.jpg' | relative_url }}" class="img-fluid rounded" style="aspect-ratio: 1; object-fit: cover;">
      </a>
    </div>
    <div class="col">
      <a href="{{ '/assets/img/resto1c.jpg' | relative_url }}" data-lightbox="resto1">
        <img src="{{ '/assets/img/resto1c.jpg' | relative_url }}" class="img-fluid rounded" style="aspect-ratio: 1; object-fit: cover;">
      </a>
    </div>
  </div>
...
<div style="margin-bottom: 40px;">
  ...
  <div class="row row-cols-3 g-2">
    <div class="col">
      <a href="{{ '/assets/img/ralph1.jpeg' | relative_url }}" data-lightbox="ralph1">
        <img src="{{ '/assets/img/ralph1.jpeg' | relative_url }}" class="img-fluid rounded" style="aspect-ratio: 1; object-fit: cover;">
      </a>
    </div>
    <div class="col">
